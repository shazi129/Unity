...
//			#pragma multi_compile _MOTION1_ON
//			#pragma multi_compile _MOTION1_BLEND_ADD_ON _MOTION1_BLEND_MINUS_ON _MOTION1_BLEND_MULTIPLY_ON _MOTION1_BLEND_DISTORT_ON
//			#pragma multi_compile _MOTION1_MOVE_ON
//			#pragma multi_compile _MOTION1_ROTATE_ON
//
//			#pragma multi_compile _MOTION2_ON
//			#pragma multi_compile _MOTION2_BLEND_ADD_ON _MOTION2_BLEND_MINUS_ON _MOTION2_BLEND_MULTIPLY_ON _MOTION2_BLEND_DISTORT_ON
//			#pragma multi_compile _MOTION2_MOVE_ON
//			#pragma multi_compile _MOTION2_ROTATE_ON
//
//			#pragma multi_compile _MOTION3_ON
//			#pragma multi_compile _MOTION3_BLEND_ADD_ON _MOTION3_BLEND_MINUS_ON _MOTION3_BLEND_MULTIPLY_ON _MOTION3_BLEND_DISTORT_ON
//			#pragma multi_compile _MOTION3_MOVE_ON
//			#pragma multi_compile _MOTION3_ROTATE_ON
//
//			#pragma multi_compile _MOTION4_ON
//			#pragma multi_compile _MOTION4_BLEND_ADD_ON _MOTION4_BLEND_MINUS_ON _MOTION4_BLEND_MULTIPLY_ON _MOTION4_BLEND_DISTORT_ON
//			#pragma multi_compile _MOTION4_MOVE_ON
//			#pragma multi_compile _MOTION4_ROTATE_ON
...
//				#if _MOTION3_ON && _MOTION2_ON && _MOTION3_BLEND_DISTORT_ON
					//uv2 += DoDistort(mask.r, _MotionTex3, uv3, _DistortParam3);
//				#endif
//				#if _MOTION2_ON && _MOTION1_ON && _MOTION2_BLEND_DISTORT_ON
					//uv1 += DoDistort(mask.b, _MotionTex2, uv2, _DistortParam2);
//				#endif
//				#if _MOTION1_ON && _MOTION1_BLEND_DISTORT_ON
					uv += DoDistort(mask.g, _MotionTex1, uv1, _DistortParam1);
//				#endif
...
//						result.xyz += motion1.xyz*mask.g*mulColor1;
//					#elif _MOTION1_BLEND_MINUS_ON
//						result.xyz -= motion1.xyz*mask.g*mulColor1;
//					#elif _MOTION1_BLEND_MULTIPLY_ON
//						result.xyz = lerp(result.xyz, result.xyz*motion1.xyz*mulColor1, mask.g*motion1.a);
//					#endif
//				#endif
...
//					#if _MOTION2_BLEND_ADD_ON
						result.xyz += motion2.xyz*mask.b*mulColor2;
//					#elif _MOTION2_BLEND_MINUS_ON
//						result.xyz -= motion2.xyz*mask.b*mulColor2;
//					#elif _MOTION2_BLEND_MULTIPLY_ON
//						result.xyz = lerp(result.xyz, result.xyz*motion2.xyz*mulColor2, mask.g*motion2.a);
//					#endif
//				#endif
//
...
//					#if _MOTION3_BLEND_ADD_ON
						result.xyz += motion3.xyz*mask.r*mulColor3;
//					#elif _MOTION3_BLEND_MINUS_ON
//						result.xyz -= motion3.xyz*mask.r*mulColor3;
//					#elif _MOTION3_BLEND_MULTIPLY_ON
//						result.xyz = lerp(result.xyz, result.xyz*motion3.xyz*mulColor3, mask.g*motion3.a);
//					#endif
//				#endif
//
...
//						result.xyz = lerp(result.xyz, result.xyz*motion4.xyz*mulColor4, mask.g*motion4.a);
//					#endif
//				#endif
