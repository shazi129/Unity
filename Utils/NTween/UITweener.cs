...
namespace NTween
{
    ...
    public abstract class UITweener : MonoBehaviour
    {
        ...
        /// <summary>
        /// Whether Sample(0, false) will be called at Start()
        /// </summary>
        ...
        /// <summary>
        /// How many frames will the tweener wait before starting the tween?
        /// </summary>
        ...
        /// <summary>
        /// How many times will the tweener execute?
        /// </summary>
        ...
        [HideInInspector]
        public Action<UITweener> onFinishCallback;
        ...
        public uint tweenLoopTimes { get { return mLoopTimes; } set { mLoopTimes = value; } }
        ...
        {
            if (resetAtStart) Sample(0, false);
            Update();
        }
        ...
        void Update()
        {
            ...
            if (Time.frameCount < mStartFrame) return;
