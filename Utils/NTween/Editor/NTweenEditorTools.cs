...
namespace NTween
{
    ...
    public class NTweenEditorTools
    {
        ...
        static public IntVector IntPair(string prefix, string leftCaption, string rightCaption, int x, int y)
        {
            ...
            NTweenEditorTools.SetLabelWidth(48f);
        ...
        static public Rect IntRect(string prefix, Rect rect)
        {
            ...
            NTweenEditorTools.IntVector a = NTweenEditorTools.IntPair(prefix, "Left", "Top", left, top);
            NTweenEditorTools.IntVector b = NTweenEditorTools.IntPair(null, "Width", "Height", width, height);
        ...
        static public Vector4 IntPadding(string prefix, Vector4 v)
        {
            ...
            NTweenEditorTools.IntVector a = NTweenEditorTools.IntPair(prefix, "Left", "Top", left, top);
            NTweenEditorTools.IntVector b = NTweenEditorTools.IntPair(null, "Right", "Bottom", right, bottom);
        ...
        public static void DrawTexture(Texture2D tex, Rect rect, Rect uv, Color color, Material mat)
        {
            ...
            // Draw the background
            NTweenEditorTools.DrawTiledTexture(outerRect, NTweenEditorTools.backdropTexture);
        ...
        //    if (NTweenEditorTools.DrawPrefixButton(spriteName, options))
        //    {
        //        NGUISettings.atlas = atlas;
        //        NGUISettings.selectedSprite = spriteName;
        //        SpriteSelector.Show(callback);
        ...
        //    GUILayout.BeginHorizontal();
        //    {
        //        if (NTweenEditorTools.DrawPrefixButton("Sprite"))
        //        {
        //            NGUISettings.atlas = atlas;
        //            NGUISettings.selectedSprite = spriteName;
        //            SpriteSelector.Show(callback);
        ...
        //                    if (sprite != null)
        //                    {
        //                        NTweenEditorTools.RegisterUndo("Edit Sprite Name", atlas);
        //                        sprite.name = newName;
        ...
        //                            {
        //                                NTweenEditorTools.RegisterUndo("Edit Sprite Name", sp);
        ...
        static public void FixUniform(GameObject go)
        {
            ...
            //{
            //    if (!NTweenEditorTools.IsUniform(t.localScale))
            //    {
            //        NTweenEditorTools.RegisterUndo("Uniform scaling fix", t);
            //        t.localScale = Vector3.one;
        ...
        static public int GetClassID(System.Type type)
        {
            ...
            NTweenTools.DestroyImmediate(go);
            return classID;
        }
