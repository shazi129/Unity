...
namespace NTween
{
    ...
    static public class NTweenTools
    {
        ...
        /// <summary>
        /// Globally accessible volume affecting all sounds played via NTweenTools.PlaySound().
        /// </summary>
        ...
        static public bool fileAccess
        {
            get
            {
                ...
                //    Application.platform != RuntimePlatform.OSXWebPlayer; //Unity2018.2版本已经废弃RuntimePlatform.OSXWebPlayer和RuntimePlatform.WindowsWebPlayer
                return true;
            }
        }
        ...
        static public void SetDirty(UnityEngine.Object obj)
        {
            ...
            if (obj)
            {
                //if (obj is Component) Debug.Log(NTweenTools.GetHierarchy((obj as Component).gameObject), obj);
                //else if (obj is GameObject) Debug.Log(NTweenTools.GetHierarchy(obj as GameObject), obj);
        ...
        [System.Obsolete("Use NTweenTools.GetActive instead")]
		...
		return null;
#else
            if (!NTweenTools.fileAccess) return null;
